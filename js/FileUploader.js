(function() {      
    ...
    FileUploader.prototype.init = function(selector) {
      ...
      this.$error = document.querySelector(selector + ' + span.file_error');
    ...
    function _handleInputChange(e) {
      ...
      if (!file.type.match(pattern)) {
          ...
          this.$error.textContent = 'Formato Inválido';
          this.$error.classList.add('aparecer');
          return;
      }
      
      this.$error.classList.remove('aparecer');
